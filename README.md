...
| **Language** | Java 25 |
| **Build** | Maven 3.9+ |
| **Testing** | JUnit Jupiter 6.0.3 (754 tests) |
...
- **Trees** — AVL, BST, Expression Tree, Heap, Max/Min Heap, Simple Tree, Splay, Static Binary, Suffix Tree, Trie, Threaded Tree
- **Lists** — Single/Double/Circular/Double Circular Linked Lists, Skip List
- **Stacks** — Adaptive, Array, Linked List, Stack with format
- **Queues** — Array, Dynamic, Static, Heap
...
- **Recursion** — Alphabetically Sorted, Majority Element
...
└── (mirrors main structure, 75 test files)
```
