...
class InterpolationSearchTest {
    ...
    @Test
    @DisplayName("Run interpolation search algorithm.")
    void printInterpolationSearch() {
        int[] array = {10, 20, 30, 40, 50, 60, 70, 80, 90};
        out.println("Arreglo original:");
        ArrayUtils.printArray(array);

        out.println("Buscando el 50:");
        int index = InterpolationSearch.interpolationSearch(array, 0, array.length - 1, 50);
        ...
        index = InterpolationSearch.interpolationSearch(array, 0, array.length - 1, 25);
