...
class ExponentialSearchTest {
    ...
    @Test
    @DisplayName("Run exponential search algorithm.")
    void printExponentialSearch() {
        int[] array = {10, 20, 30, 40, 50, 60, 70, 80, 90};
        out.println("Arreglo original:");
        ArrayUtils.printArray(array);

        out.println("Buscando el 50:");
        int index = ExponentialSearch.exponentialSearch(array, 50);
