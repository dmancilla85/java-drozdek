...
class SentinelLinearSearchTest {
    ...
    @Test
    @DisplayName("Run sentinel linear search algorithm.")
    void printSentinelLinearSearch() {
        int[] array = {10, 20, 30, 40, 50, 60, 70, 80, 90};
        out.println("Arreglo original:");
        ArrayUtils.printArray(array);

        out.println("Buscando el 50:");
        int index = SentinelLinearSearch.sentinelLinearSearch(array, 50);
