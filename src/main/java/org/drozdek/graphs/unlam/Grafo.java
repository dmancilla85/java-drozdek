...
public class Grafo {
	...
	public static Grafo crearAleatorio(int n, int conexividad) {
		Grafo al = new Grafo(n);
	 ...
	 * @param nuevo
	 */
	public void deepFirstSearch(int v, ArrayList<Vertice> verticesVisitados, Grafo nuevo) {
	 ...
	 * @return
	 */
	public Grafo busquedaPrimeroEnProfundidad() {

		Calendar ini = Calendar.getInstance();

		Grafo busq = new Grafo(cardinality());
	 ...
	 * @return
	 */
	public Grafo busquedaPrimeroEnAmplitud() {
