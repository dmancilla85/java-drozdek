...
public class MinimumHeap<T extends Comparable<T>> implements TreeInterface {
    ...
    /// Adds an element and restores the min-heap property by sifting it up.
    ///
    ...
    ///
    /// @return previous minimum, or null when the heap is empty
    public T extractMin() {
        if (heap.isEmpty()) {
            return null;
        }
    ...
    ///
    /// @return current minimum, or null when the heap is empty
    public T getMin() {
        if (heap.isEmpty()) {
            return null;
        }
    ...
    public void changeValueOnAKey(int index, T newValue) {
     ...
     /// Lowers the value at the given index and sifts it up towards the root.
    ///
    ...
    /// Raises the value at the given index and sifts it down towards the leaves.
    ///
