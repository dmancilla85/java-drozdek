...
import org.drozdek.lists.iterators.SinglyLinkedListIterator;
...
/// - William Fiset. *Data Structures: Linked Lists*. YouTube, 2020.
/// - Adam Drozdek. *Data Structures and Algorithms in Java*, 2nd Ed. Chapter 3.
public class SinglyLinkedList<T> implements Iterable<T>, ListInterface<T> {
    ...
    public SinglyLinkedListNode<T> viewHeadNode() {
        return head;
    }
}
