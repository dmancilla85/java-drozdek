...
///
/// This implementation extends DoublyLinkedList but modifies the addToTail() method to maintain
...
public class DoublyCircularLinkedList<T> extends DoublyLinkedList<T> {
    ...
    public void addToTail(T data) {
        if (isEmpty()) {
            ...
            DoublyLinkedListNode<T> node = new DoublyLinkedListNode<>(data, head, tail);
